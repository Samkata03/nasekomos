...
import bioFertilizerImg from "../assets/bio-fertilizer.jpg";
...
export const products: Product[] = [
  ...
  {
    id: "bio-fertilizer",
    name: "Био тор от брашнян червей",
    scientificName: "Tenebrio molitor frass",
    description:
      "100% био тор директно от ларвите на брашния червей. Естествен източник на хитин, полезни микроорганизми и хранителни вещества за вашите растения.",
    benefits: [
      "Естествен източник на хитин",
      "Укрепва растенията",
      "Подобрява защитата срещу вредители",
    ],
    ...
    details: [
      {
        title: "За торта от насекоми",
        content:
          "Известно е, че торта от насекоми е една от най-добрите, които можете да използвате за вашите растения. Нашата 100% био тор е директно от ларвите на брашния червей, който отглеждаме. Торта на насекомото естествено съдържа необходимите за растенията полезни микроорганизми и единственият незабавно на разположение на растенията източник на хитин.",
      },
      {
        title: "Ползи от хитина",
        content:
          "Хитинът укрепва растението отвътре навън и сигнализира на растението да произвежда естествени вещества, които отблъскват вредителите и гъбични патогени. Хитинът и хитозанът защитават растението от ботрити (сива плесен), брашнеста мана, ранна и късна болест, гъбични патогени в кореновата зона (кореново гниене) и нематоди, подхранващи корените.",
      },
      {
        title: "Съдържание и приложение",
        content:
          "Съдържа малки частици от кожа на брашнен червей, които не могат да бъдат филтрирани, но това само увеличава количеството хитин в торта. 1 литър тор е достатъчен за 10 м².",
      },
    ],
  },
  {
