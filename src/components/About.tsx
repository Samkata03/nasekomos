...
const values = [
  {
    ...
    description:
      "Насекомите се отглеждат в чиста и подходяща среда, с правилно хранене и хигиена.",
  },
  {
    icon: Heart,
    title: "Грижа за любимците",
    description:
      "Вярваме, че качествената храна е основа за здрави и щастливи домашни любимци.",
  },
  {
    icon: Recycle,
        ...
        <div className="grid items-center gap-12 lg:grid-cols-2">
          <div>
            ...
            <p className="mt-6 text-lg leading-relaxed text-muted-foreground">
              {siteName} е малък български бизнес, създаден от любов към влечугите и желанието да
              се предложи качествена, свежа и достъпна жива храна. Всички продукти се отглеждат
